...
The findings highlight a fundamental limitation of static threshold detection against low-and-slow attacks, and point toward why layered defences — combining IDS with firewall rules, IPS mode, and community rulesets — are essential in production environments.
